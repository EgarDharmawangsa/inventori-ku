...
@section('container')
    ...
    <div class="row justify-content-center">
        <div class="col-md-8 col-lg-6">
            <form action="/petugass" method="POST" class="p-4 border rounded bg-light custom-form-ae">
                @csrf
                <div class="mb-3">
                    <label class="form-label" for="namaPetugas">Nama</label>
                    <input type="text" class="form-control @error('namaPetugas') is-invalid @enderror" id="namaPetugas"
                        name="namaPetugas" required autofocus>
                    @error('namaPetugas')
